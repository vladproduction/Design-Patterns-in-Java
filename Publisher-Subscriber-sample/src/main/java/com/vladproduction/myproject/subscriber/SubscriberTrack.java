...
public class SubscriberTrack implements Subscriber {

    private LocalMessagingService localMessagingService;

    public SubscriberTrack(LocalMessagingService localMessagingService) {
    ...
    public void receiveMessage(Message message) {
        ...
        System.out.println("Track message: " + message);
    }
}
